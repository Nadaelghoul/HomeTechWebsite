        ...
        <section>
            <div class="container-section">
                ...
                <div class="content-wrapper">
                    ...
                    <form action="{{ route('topProviderRequest.store')}}" method="POST">
                    @csrf
                    <div class="form">
                                ...
                                <div class="form-container">
                                    <div class="form-part1">
                                        ...
                                        <textarea name="requirements" rows="5" cols="70" placeholder="Enter your requirements to provider"required id="message">{{ old('requirements') }} </textarea>
                                    ...
                                    <div class="form-part2">
                                        ...
                                        <div class="form-group">
                                            <label for="Problem_Address"><span style="color: red">*</span>Problem Address:</label>
                                            <input type="text" name="Problem_Address" id="Problem_Address"  value="{{ old('Problem_Address') }}" required>
                                            @error('Problem_Address')<div style="color: red;font-size:15px;">{{'*'.$message }}</div>@enderror
                                        </div>

                                        <div class="form-group">
                                            <label for="day"><span style="color: red">*</span>Select the execution day:</label>
                                            <input type="date" name="execution_day" id="day"  value="{{ old('execution_day')}}"   min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" required>
                                        ...
                                        <input type="hidden" name="service_provider" value="{{ request()->query('service_provider') }}">
                    ...
                    <div class="summary-wrapper">
                        <div class="card">
                            ...
                            <div class="body-card">
                                <p style="margin-bottom:-1px"><span>Service:</span>{{request()->query('service','Not specified')}}</p>
                                <p style=" display:inline;"><span >Service Provider:</span><p style="display:inline;font-size:13px">{{request()->query('service_provider','Not specified')}}</p></p>
                                <p style="margin-top:-10px;margin-top:-10"><span>Type:</span>{{request()->query('title','Not specified')}}</p>
                                <p style="margin-top:-10px;margin-top:-10"><span>Price:</span>{{request()->query('price','Not specified')}}</p>
